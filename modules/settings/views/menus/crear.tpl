...
<div class="well col-md-8">
    <form name="form1" method="post" action="">
        ...
        <div class="btn-group" role="group">
            <button type="button" class="btn btn-primary" href="{$_layoutParams.root}settings/menus/crear"><i class="glyphicon glyphicon-backward icon-white"> </i> Crear</a></button>
